...
public class AddGroupToGroup extends Command {
	
	@Override
	public String get() {
		return "add-group-to-group";
	}

	@Override
	public String getDescription() {
		return "Add a group to a group.";
	}
	...
	public Argument[][] getArguments() {
		return new Argument[][]{
			{
				new Argument(false, "groupname of group to add", ArgumentType.text),
	...
	public String run(ServerClientHandler handler, List<Object> arguments, int syntax) throws IOException, TimeoutException, InterruptedException, ForcedReturnException, SessionExpiredException, HasNotTheRightsException, UserDoesNotExistException, GroupDoesNotExistException {
		...
		if (RequestHandler.addGroupToGroup(handler.getUsername(),(String) arguments.get(0),(String) arguments.get(1)))
			return "Group successfully added to group!";
		else
			return "Group couldn't be added!";
	}
}
